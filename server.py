...
mcp = MCPServer(
    ...
    instructions=(
        ...
        "Use download_file when you need to return a generated file."
    ),
)
...
def run_command(
    ...
    Use only for commands that finish quickly.
    Use start_job for long-running operations.
    """
...
def job_output(
    ...
    """
    Get complete output from a background job.
    """
...
def download_file(
    ...
    """
    Return a direct public URL for a workspace file.
    ...
    Returns:
        ...
        https://mcp-linux-production.up.railway.app/files/renders/video.mp4
    """
    ...
    # The public URL is deliberately simple.
    #
    # No token.
    # No authentication.
    # No database.
    ...
    #
    # Just the Railway URL + /files/ + workspace path.
...
async def file_download_endpoint(
    ...
    file_path = request.path_params.get(
        "path",
        ""
    )
...
if __name__ == "__main__":
    ...
    # Keep EXACTLY the same MCP configuration
    # that your original working server used.
